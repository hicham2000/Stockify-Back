...
class RecetteRepositoryTest {
    ...
    @Autowired
    RecetteRepositoryTest(RecetteRepository recetteRepository, StockRepository stockRepository) {
    ...
    void testFindAllByStockIdCustomQuery() {
        ...
        Recette recette1 = new Recette("Recette 1", "Description 1", 60, stock, Arrays.asList(new Ingredient()), 0);
        Recette recette2 = new Recette("Recette 2", "Description 2", 90, stock, Arrays.asList(new Ingredient()), 0);
